...
The action will perform a `npm publish` and if the publishing finish succesfully will allow to continue to the next step, otherwise will fails. Se houver qualquer problema ao publicar um pacote você notará usando essa ação.
