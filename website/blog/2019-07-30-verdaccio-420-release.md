...
* **New Verdaccio Monorepo** development begun early this month, we are migrating small repositories, plugins and other tools to create a unique ecosystem. [Feel free to contribute](https://github.com/verdaccio/monorepo).
