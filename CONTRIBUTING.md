...
> note: linting (oxlint) and formatting (oxfmt) are run separately, keep code formatting
> before push.
...
1. Keep in mind the [life-cycle to load a plugin
   ](https://verdaccio.org/docs/en/dev-plugins)
2. You are free to host your plugin in your repository
3. Provide a detailed description of your plugin to help users understand how to
   use it
